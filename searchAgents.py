...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        self._visited = (False, False, False, False)
    def getStartState(self):
        """
        ...
        """
        "*** YOUR CODE HERE ***"
        return (self.startingPosition,self._visited)
    def isGoalState(self, state):
        """
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                for i in range(len(self.corners)):
                    if self.corners[i] == next_state:
                        next_path[i] = True
                next_path = tuple(next_path)
                successors.append(((next_state, next_path),action, cost))
...
def cornersHeuristic(state, problem):
    ...
    for corner in corners_left:
        dist = manhattanDistance(point, corner)
